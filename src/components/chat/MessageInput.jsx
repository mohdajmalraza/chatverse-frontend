...
//         <button
//           type="button"
//           className="flex-shrink-0 rounded-full p-2.5 text-gray-500 transition hover:bg-gray-100"
//         >
//           📎
//         </button>
...
//           placeholder="Type a message..."
//           disabled={sending}
//           className="flex-1 rounded-full bg-gray-100 px-4 py-2.5 text-sm text-gray-900 outline-none placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-blue-500 disabled:opacity-60"
//         />

//         <button
//           type="submit"
//           disabled={!message.trim() || sending}
//           className="flex-shrink-0 rounded-full bg-blue-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-gray-300"
//         >
